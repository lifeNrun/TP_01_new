...
(function (M, T, p) {
    ...
    function Jb(b) {
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", function (b, j, m, k, l, u, o, z, r) {
            ...
            function $(a, b, c, d, e, j, h) {
                ...
                c.html("");
                k.get(z, {cache: l}).success(function (l) {
                    var k, z, l = Lb(l);
                    if (j) {
            ...
            function P(a, b) {
                var c = j(b, !0);
                c && a.push({
                    priority: 0, compile: S(function (a, b) {
    ...
    function Pc(b, a) {
        ...
        for (var l = [], u, o = 0, z = [],
            ...
            if (c("\"'"))k(r); else if (e(r) || c(".") && e(d()))j(); else if (i(r)) {
                ...
                G ? (l.push({index: o, text: n, fn: G}), o += 3) : A ? (l.push({
                    index: o,
                    text: x,
                    fn: A
                }), o += 2) : v ? (l.push({
    ...
    function Uc(b, a) {
        ...
        return {
            defer: e, reject: i, when: function (f, h, j) {
    ...
    n({
        data: Bb, inheritedData: Ma, scope: function (b) {
            return Ma(b, "$scope")
                    ...
                    function j(j, k, o) {
                        return function (m, r, p) {
                            ...
                            if (w) {
                                ...
                                if (!g.transitions && !A && !$ || (r.inheritedData(a) || q).running)k(m, r, p), o(m, r, p); else {
                                    var O = m.data(a) || {};
                    ...
                    function i() {
                        ...
                        for (z = c.length; y < z; y++) {
                            ...
                            if (w.length <= y)q = {
                                ...
                                label: h.label
                            }, v = [q], w.push(v), f.append(q.element); else if (v = w[y], q = v[0], q.label != d)q.element.attr("label",
                                q.label = d);
                            C = null;
                            A = 0;
